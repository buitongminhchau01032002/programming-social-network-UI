            ...
            {user ? (
                <div className="flex items-center space-x-3">
                    <button className="flex h-9 min-w-[120px] items-center justify-center rounded-md bg-primary px-5 text-sm font-medium text-white transition hover:bg-primary-dark">
                        <span className="pr-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6 pt-0.5">
                    ...
                    <div className="flex items-center space-x-1">
                        ...
                        <Popover className="relative">
                            ...
                            <Popover.Panel className="absolute top-full right-0 z-10 w-80 translate-y-3 space-y-3 rounded-lg border bg-white p-3 shadow-xl">
                                ...
                                <button onClick={() => dispatch(userActions.logout())} className="flex h-9 w-full min-w-[120px] items-center justify-center rounded-md bg-primary px-5 text-sm font-medium text-white transition hover:bg-primary-dark">
                                    Đăng xuất
                                </button>
                            </Popover.Panel>
                        </Popover>
                ...
                <div className="flex items-center space-x-2">
                    <button className="flex h-9 min-w-[120px] items-center justify-center rounded-md border border-primary px-5 text-sm font-medium text-primary-dark transition hover:bg-primary hover:text-white">Đăng ký</button>
                    <Link to="sample-login" className="flex h-9 min-w-[120px] items-center justify-center rounded-md bg-primary px-5 text-sm font-medium text-white transition hover:bg-primary-dark">
                        Đăng nhập
                    </Link>
                </div>
            )}
